...
import 'package:gitboy/page/home/featured_page.dart';
    ...
    return WillPopScope(
      ...
      child: DefaultTabController(
        ...
        child: Scaffold(
          ...
          body: TabBarView(
            children: <Widget>[
              OschinaPage(query: 'featured'), //推荐
              OschinaPage(query: 'popular'), //热门
              OschinaPage(query: 'latest'), //最近更新
              Container(),
            ],
          ),
          drawer: Drawer(
                        ...
                        children: <Widget>[
                          Row(
                            children: <Widget>[
                              InkWell(
                                onTap: (){
                                  ExtendedNavigator.ofRouter<AppRouter>().pushMyPage();
                                },
                                child: ClipOval(
                                  child: FadeInImage.assetNetwork(
                                    image: value?.userProfile?.user?.avatarUrl ?? '',
